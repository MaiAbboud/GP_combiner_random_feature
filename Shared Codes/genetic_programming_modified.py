...
#     #use random number of n_features
#     # n_features = np.random.randint(1, n_features)
#     # Unpack parameters
...
#         graph.render(f'images/random/feature/ex4_tree_{i}', format='png', cleanup=True)
...
#             # choice = num_selected_features + len(self.function_set)
...
#                     # terminal = random_state.choice(selected_features)
